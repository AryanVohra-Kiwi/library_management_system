...
SECRET_KEY = 'django-insecure-b#*0no1%y%04m=m(14p3g1lw_&od27c2*@=8ib-60rin-8x!5e'
...
SWAGGER_SETTINGS = {
    'USE_SESSION_AUTH': False,  # disable Basic/Django session auth in Swagger
...
EMAIL_USE_TLS = True  # TLS is a boolean, so this is fine
